export default function Card() {
  return (
    ...
    <div className="flex items-center justify-center h-screen ">
      <div className=" mx-auto bg-white rounded-3xl shadow-xl dark:border  dark:border-gray-200">
        <div className="grid rounded-3xl max-w-[370px] shadow-sm bg-slate-100  flex-col dark:bg-gray-800 dark:text-white">
          <img
